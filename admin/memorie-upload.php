...
<body>
    ...
    <div class="upload-container">
        <form action="uploads3.php" method="post" enctype="multipart/form-data" class="form">
            ...
            <label>
                <input type="radio" name="category" value="graphic" checked>
                Graphic Designing
            </label>
            <br><br>
            <input type="submit" name="submit" value="Upload">
        </form>
        <form action="video-upload3.php" method="post" enctype="multipart/form-data" class="form" id="videoUploadForm">
        ...
        if (file_exists($jsonFile) && sizeof(json_decode(file_get_contents($jsonFile), true)) > 0) {
            ...
            foreach ($videos as $video) {
                ...
                echo "<div class='video-item'>
                    ...
                    <form action='delete-video-memorie.php' method='post' class='delete-form' style='display:inline;'>
