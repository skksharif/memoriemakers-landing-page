    ...
    <body>
        ...
        <div class="upload-container">
            <form action="uploads2.php" method="post" enctype="multipart/form-data" class="form">
            ...
            <form action="video-upload1.php" method="post" enctype="multipart/form-data" class="form" id="videoUploadForm">
            ...
            if (file_exists($jsonFile) && sizeof(json_decode(file_get_contents($jsonFile), true)) > 0) {
                ...
                foreach ($videos as $video) {
                    ...
                    echo "<div class='video-item'>
                        ...
                        <form action='delete-video-jayaram.php' method='post' class='delete-form' style='display:inline;'>
